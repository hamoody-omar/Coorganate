...
@login_required
def medical_professional_organization_details(request):
    ...
    return render(request, 'medical_professional/medical_professional_organization_details.html', context_dict)
